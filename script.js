...
topic.list = [
    {
        num: "| 第ㄧ題 ｜",
        issue: "海峽對岸的強國主張九二共識、和平統一台灣，並實施一國兩制，你的回應是：",
        ans1: "捍衛中華民國主權，主張一中各表的「九二共識」",
        ans2: "拒絕一國兩制，「中華民國台灣」是最大共識",
        ans3: "對岸必須正視中華民國存在，在對岸未實現自由民主法治前，主張維持現狀",
        res1: "0",
        res2: "1",
        res3: "2"
    },
    {
        num: "| 第二題 ｜",
        issue: "我國生育率持續下降，少子化問題越趨嚴重，有許多人不想生或不敢生，我主張：",
        ans1: "0到6歲國家幫忙養，推行666育兒政策",
        ans2: "育兒津貼再加碼，0到6歲國家跟你一起養",
        ans3: "不跟隨花錢補助，推動幼兒提前納入國民義務教育",
        res1: "3",
        res2: "4",
        res3: "5"
    },
    {
        num: "| 第三題 ｜",
        issue: "我國青年畢業後，不確定要幹大事還是當上班族，對於未來充滿徬徨，我主張：",
        ans1: "射出「青年政策三箭」，推動學貸免息、雙語教育、老青共居",
        ans2: "學貸減壓再活化、政府幫你補房租、創業創新就來TTA",
        ans3: "設立青年及銀髮社會住宅",
        res1: "6",
        res2: "7",
        res3: "8"
    ...
    {
        num: "| 第四題 ｜",
        issue: "照顧台灣勞工，讓他們能有力氣賺錢，我主張：",
        ans1: "聽方丈的話修改一例一休，再拋「勞動三箭」",
        ans2: "一例一休執行給予企業彈性，減稅加薪顧勞工",
        ans3: "維持一例一休的精神，但調整為「異業異法」",
        res1: "9",
        res2: "10",
        res3: "11"
    },
